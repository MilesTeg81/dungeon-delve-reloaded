...
const MAP_SIZE = 24        # def 48 - Size of the map, which is always square
const MAX_DEPTH = 3        # default 4 - Recursion depth when generating
